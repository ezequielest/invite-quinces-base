...
function modules() {
  ...
  var magnificPopup = gulp.src('./node_modules/magnific-popup/dist/*')
    ...
    // magnific Popup
  var simplyCountdown = gulp.src('./node_modules/simplycountdown.js/dist/*')
    .pipe(gulp.dest('./vendor/simplycountdown'));  
  // animate
  var animate = gulp.src('./node_modules/animate.css/*.css')
  .pipe(gulp.dest('./vendor/animate'));  
  // fakeLoader
  var fakeLoader = gulp.src('./node_modules/jq-fakeloader/dist/*')
    .pipe(gulp.dest('./vendor/fake-loader'));  
  // jQuery
  var jquery = gulp.src([
  ...
  return merge(bootstrap, fontAwesomeCSS, fontAwesomeWebfonts, jquery, jqueryEasing, simpleLineIconsFonts, simpleLineIconsCSS,oldCarousel,fakeLoader,animate,simplyCountdown,magnificPopup);
}

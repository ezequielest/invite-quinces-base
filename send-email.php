...
try {
    ...
    //$mail->addAddress('ezequiel.estigarribia@gmail.com', 'Mónica');     // Add a recipient
    $mail->addAddress('monisb1982@hotmail.com', 'Mónica');     // Add a recipient
    ...
    $mail->Body     = 'Felicitaciones, hay una nueva confirmaci&oacute;n para tu quince!<br><br>';
